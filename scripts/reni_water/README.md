...
При старте Hermes.Wpf, если передача за текущий месяц ещё не отмечена (окно с 1-го числа 09:00), показывается всплывающее окно со звуком и кнопкой **Run Now** (локальный Playwright, не CLI).
