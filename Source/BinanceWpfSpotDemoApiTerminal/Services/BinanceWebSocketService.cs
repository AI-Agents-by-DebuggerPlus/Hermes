...
namespace BinanceWpfSpotDemoApiTerminal.Services
{
    ...
    {
        private const string WsUrl = "wss://testnet.binance.vision/ws";
        ...
        public async Task ConnectAsync()
        {
            ...
            Log("Подключение к WebSocket Testnet...");
            ...
            try
            {
                ...
                Log("Успешно подключено к WebSocket Testnet.");
        ...
        private void ProcessMessage(string json)
        {
            try
            {
                using (var doc = JsonDocument.Parse(json))
                {
                    ...
                    {
                        return; // Пропускаем системные ответы на подписку
                    }
            ...
            {
                // Игнорируем ошибки парсинга некорректных кадров
            }
        }
