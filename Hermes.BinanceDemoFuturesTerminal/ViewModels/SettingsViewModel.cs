...
public sealed class SettingsViewModel : ObservableObject
{
    ...
    private string _maxOrderUsdt = "500";
    ...
    public string MaxOrderUsdt
    {
        get => _maxOrderUsdt;
        set => SetProperty(ref _maxOrderUsdt, value);
    }
    ...
    private void LoadFrom(PlatformSettings s)
    {
        ...
        MaxOrderUsdt = s.MaxOrderUsdt.ToString("F0");
    ...
    {
        if (!TryParsePositive(MaxOrderUsdt, out var maxOrder)
        ...
        settings.MaxOrderUsdt = maxOrder;
    ...
    {
        value = 0;
        return double.TryParse(text?.Replace(',', '.'), System.Globalization.NumberStyles.Any,
